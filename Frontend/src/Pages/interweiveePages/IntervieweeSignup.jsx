  ...
  <div className="w-full h-screen bg-gray-700 flex items-center justify-center">
      <form>
        <div className="container h-1/2 flex flex-col bg-transparent shadow-2xl rounded-lg items-center gap-5 ">
            <h1 className="font-extrabold text-lg mt-10 text-white">Interviewee SignUp</h1>
          ...
          <h1>OR</h1>
          <Button className="mb-5"><FcGoogle className="mx-3"/> SignUp With Google</Button>
         <Link to="/interviewee-login"><h1 className="ml-32 text-blue-100 cursor-pointer mb-2">Already Have an Account ?</h1></Link> 
        </div>
      </form>
    </div>
    </>
