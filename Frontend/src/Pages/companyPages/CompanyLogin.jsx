      ...
      <div className="w-full h-screen flex bg-gray-700 items-center justify-center ">
        <form>
          <div className=" container flex flex-col items-center gap-5 bg-transparent shadow-2xl rounded-lg" >
            <h1 className="font-extrabold text-lg mt-10 text-white ">Company Login</h1>
            ...
            <Link to="/company-signup"><h1 className="ml-32 text-blue-100 cursor-pointer mb-2">Don't Have an Account ?</h1></Link>
          </div>
        </form>
      </div>
    </>
