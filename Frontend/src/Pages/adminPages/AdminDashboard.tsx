...
const premium = async () => {
  ...
  // const [searchValue, setSearchValue] = useState<string>("");
    ...
    const premiumCompany = await axios.get("http://13.235.95.144/api/admin/premium-companies")
    const totalInterviewers = await axios.get("http://13.235.95.144/api/admin/getdata/?role=interviewer");
    const totalInterviewees = await axios.get("http://13.235.95.144/api/admin/getdata/?role=interviewee");
    const companyList = await axios.get("http://13.235.95.144/api/admin/getdata/?role=company");
